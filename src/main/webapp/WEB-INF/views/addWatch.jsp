    ...
    <body>
        ...
        <section class="container">
            <form:form modelAttribute="newDevice" class="form-horizontal">
                <fieldset>
                    <legend>Afegir rellotge intel·ligent</legend>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="sensor">Sensor Salut</label>
                        <div class="col-lg-10">
                            <form:input id="sensor" path="sensor" type="text" class="form:input-large"/>
                        </div>
                    </div>   
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="profunditat">Resistent a l'aigua</label>
                        <div class="col-lg-10">
                            <form:input id="profunditat" path="profunditat" type="text" class="form:input-large"/>
                        </div>
                    </div>                           
                    <div class="form-group">
