        ...
        <section class="container">
            <form:form modelAttribute="newDevice" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="connectivitat">Connectivitat</label>
                        <div class="col-lg-10">
                            <form:input id="connectivitat" path="connectivitat" type="text" class="form:input-large"/>
                        </div>
                    </div>   
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="so">Sistema Operatiu</label>
                        <div class="col-lg-10">
                            <form:input id="so" path="so" type="text" class="form:input-large"/>
                        </div>
                    </div>                           
                    <div class="form-group">
