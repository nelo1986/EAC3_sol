        ...
        <section class="container">
            <div class="row">
                    <div class="col-sm-6 col-md-6" style="padding-bottom: 15px">
                        <div class="thumbnail">
                            <div class="caption">
                                <h3>Compra d'un dispositiu</h3>
                                <p>Heu de canviar la URL per aquest patró:</p>
                                <p>/buyDevice/codi</p>
                                <p>Per exemple si voleu comprar el dispositiu amb codi: 0 seria /buyDevice/0
                                    <a href=" <spring:url value= "/buyDevice/0" /> " class="btn btn-primary">
                                        <span class="${item.icon}"/></span> Realitzar compra
                                    </a>
                                </p>
                            </div>
                        </div>
